   ...
   // android.support.v7.widget.Toolbar toolbar;
    ...
    private void initializeLexSDK() {
        ...
        CognitoCachingCredentialsProvider credentialsProvider = new CognitoCachingCredentialsProvider(
                ...
                "us-east-1:49c58d5c-0d9f-4c73-bc7f-8c65b733ad83", // Identity pool ID
        ...
        sessionkey.put("userName","Jeff");
        sessionkey.put("compName",compName);
        lexInteractionClient.textInForTextOut("Welcome Message",sessionkey);
    }
    ...
    private void textEntered() {
        ...
        if (!inConversation) {
            ...
            lexInteractionClient.textInForTextOut(text, sessionkey);
    ...
    final InteractionListener interactionListener = new InteractionListener() {
        ...
        public void onReadyForFulfillment(final Response response) {
            ...
            Log.d("Text",response.getTextResponse());
